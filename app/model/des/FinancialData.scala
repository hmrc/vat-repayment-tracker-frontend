...
/** Case class representing a small subset of the DES 1166 API response containing financial data for a VRN.
  */
...
final case class Transaction(chargeType: String, periodKey: Option[String], items: Option[Seq[Item]])

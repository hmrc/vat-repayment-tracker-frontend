...
class CompletedSpec extends BrowserSpec:
  ...
  "8. multiple completed " in {
    setup(
      partialBankDetails = true,
      singleRepayment = false,
      financialDataPeriodKeys = Seq("18AA", "18AD", "18AG", "18AJ")
    )
    ...
    Completed.readRowForPeriod("18AA") shouldBe Seq(
      ...
      "£6.56",
      "View history View history for accounting period 1 January to 31 January 2018"
    )
    Completed.readRowForPeriod("18AD") shouldBe Seq(
      "01 Jan 2001",
      "1 April to 30 April 2018",
      "£6.56",
      "View history View history for accounting period 1 April to 30 April 2018"
    )
    Completed.readRowForPeriod("18AG") shouldBe Seq(
      "01 Jan 2001",
      "1 July to 31 July 2018",
      "£6.56",
      "View history View history for accounting period 1 July to 31 July 2018"
    )
    Completed.readRowForPeriod("18AJ") shouldBe Seq(
      "01 Jan 2001",
      "1 October to 31 October 2018",
      "£5.56",
      "View history View history for accounting period 1 October to 31 October 2018"
    )

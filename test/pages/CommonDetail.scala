...
trait CommonDetail extends CommonPage {
  ...
  def assertPageIsDisplayed(vrn: Vrn, receivedDate: String, repayDate: String, checkBank: Boolean = true, checkAddress: Boolean = false)(implicit wd: WebDriver): Assertion = {

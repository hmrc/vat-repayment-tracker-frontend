...
trait CommonDetail extends CommonPage {
  ...
  def readAmount()(implicit webDriver: WebDriver): String = probing(_.findElement(By.xpath(s"/html/body/main/div[2]/div[2]/div/div/section[0]/table/tbody/tr[1]/td[3]")).getText)
  ...
  def readPeriod()(implicit webDriver: WebDriver): String = probing(_.findElement(By.xpath(s"/html/body/main/div[2]/div[2]/div/div/section[0]/table/tbody/tr[1]/td[2]")).getText)
}

...
object DesData {
  ...
  val transaction: Transaction = Transaction("VAT Return Credit Charge", "18AC")
...
""".stripMargin
  ...
  // language=JSON
  def financialDataSingleCredit(vrn: Vrn): JsValue = Json.parse(s"""
                                                 {
                                                   "idType": "VRN",
                                                   "idNumber": "${vrn.value}",
                                                   "regimeType": "VATC",
  ...
  // language=JSON
  def financialDataSingleDebit(vrn: Vrn): JsValue = Json.parse(s"""
                                                 {
                                                   "idType": "VRN",
                                                   "idNumber": "${vrn.value}",
                                                   "regimeType": "VATC",
